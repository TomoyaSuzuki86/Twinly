...
describe("BabyPanel", () => {
  ...
  it("keeps exactly two primary actions and opens meal entry from the food button", () => {
    ...
    expect(mealButton.className).toContain("--gauge-milk-track");
    expect(diaperButton.className).toContain("--gauge-diaper-track");
    expect(mealButton.className).toContain("--gauge-milk-text");
    expect(diaperButton.className).toContain("--gauge-diaper-text");
    expect(screen.getByTestId("milk-gauge-fill").className).toContain("--gauge-milk-fill");
    expect(screen.getByTestId("diaper-gauge-fill").className).toContain("--gauge-diaper-fill");
  ...
  it("toggles the sleep shortcut between sleep and wake", () => {
    ...
    expect(screen.getByTestId("sleep-gauge-fill").className).toContain("--gauge-wake-fill");
