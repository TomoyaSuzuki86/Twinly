...
const formatElapsed = (timestamp: number | null) =>
  timestamp ? `${minutesSince(timestamp)}蛻・燕` : "譛ｪ險倬鹸";
  ...
  return (
    <Card className={`flex flex-col border-border/60 ${themeDimmedBgColor}`}>
      <CardContent className="p-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="mt-1 text-base font-normal opacity-80">蜑榊屓 {lastMilkTime}</span>
          ...
          >
            ...
            <span className="mt-1 text-base font-normal opacity-80">
              {profile.diaperSize}繝ｻ谿九ｊ {remainingDiapers}
            </span>
            <span className="text-sm font-normal opacity-80">
              蜑榊屓 {lastDiaperTime} / {lastDiaperElapsed}
            </span>
          </Button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <Card className="transition-colors hover:border-amber-400/60 hover:bg-amber-500/5">
              <CardHeader className="p-4">
                <CardTitle className="text-base font-medium text-muted-foreground">縺翫・縺､</CardTitle>
              </CardHeader>
              <CardContent className="p-4 pt-0">
                <div className="flex items-baseline gap-2">
      ...
      <CardFooter className="flex min-h-0 flex-1 flex-col items-start gap-3">
        <h3 className="text-sm font-semibold text-muted-foreground">莉頑律縺ｮ繝ｭ繧ｰ</h3>
